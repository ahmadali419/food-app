            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                        <?php echo $__env->make('theme.slidertable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_slider').on('submit', function(event){
        ...
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(URL::to('admin/slider/store')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editslider').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"<?php echo e(URL::to('admin/slider/update')); ?>",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
...
function GetData(id) {
    $.ajax({
        ...
        url:"<?php echo e(URL::to('admin/slider/show')); ?>",
        data: {
            id: id
        },
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/slider/destroy')); ?>",
                data: {
                    id: id
                },
                method: 'POST',
...
function SliderTable() {
    $.ajax({
        url:"<?php echo e(URL::to('admin/slider/list')); ?>",
        method:'get',
