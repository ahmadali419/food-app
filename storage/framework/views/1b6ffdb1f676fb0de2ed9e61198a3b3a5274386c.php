...
<section class="signup-sec">
    ...
    <div class="container">
        ...
        <form id="login" action="<?php echo e(URL::to('/signin/login')); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <p class="already">New user? <a href="<?php echo e(URL::to('/signup')); ?>">Create Account</a></p>
            <p class="already"><a href="<?php echo e(URL::to('/forgot-password')); ?>">Forgot Password?</a></p>
...
</html><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/front/login.blade.php ENDPATH**/ ?>