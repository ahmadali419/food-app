...
<head>
    ...
    <title>Admin</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo asset('public/assets/images/favicon.png'); ?>">
    <!-- Pignose Calender -->
    <link href="<?php echo asset('public/assets/plugins/pg-calendar/css/pignose.calendar.min.css'); ?>" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="<?php echo asset('public/assets/plugins/chartist/css/chartist.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo asset('public/assets/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css'); ?>">

    <link href="<?php echo asset('public/assets/plugins/tables/css/datatable/dataTables.bootstrap4.min.css'); ?>" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    ********************-->
    <div id="preloader">
        <div class="loader">
            <img src="<?php echo asset('public/front/images/loader.gif'); ?>" style="width: 80px;">
        </div>
    </div>
    <!--*******************
        Preloader end
                      ...
                      <div class="modal-content">
                        ...
                        <?php echo e(csrf_field()); ?>
                          ...
                          <div class="modal-body">
                            ...
                            <label>Tax (%): </label>
                            <div class="form-group">
                                <input type="text" placeholder="Enter Tax in percentage (%)" value="<?php echo e(Auth::user()->tax); ?>" class="form-control" name="tax" id="tax">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="lat" id="lat" value="<?php echo e(Auth::user()->lat); ?>" readonly="">
                            </div>

                            <label>Longitude</label>
                            <div class="form-group">
                                <input type="text" class="form-control" name="lang" id="lang" value="<?php echo e(Auth::user()->lang); ?>" readonly="">
                            </div>

                            <label>Delivery Charge: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Delivery Charge" value="<?php echo e(Auth::user()->delivery_charge); ?>" class="form-control" name="delivery_charge" id="delivery_charge">
                            </div>

                            <label>Max. Order QTY: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Max. Order QTY" value="<?php echo e(Auth::user()->max_order_qty); ?>" class="form-control" name="max_order_qty" id="max_order_qty">
                            </div>

                            <label>Min. Order Amount: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Min. Order Amount" value="<?php echo e(Auth::user()->min_order_amount); ?>" class="form-control" name="min_order_amount" id="min_order_amount">
                            </div>

                            <label>Max. Order Amount: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Max. Order Amount" value="<?php echo e(Auth::user()->max_order_amount); ?>" class="form-control" name="max_order_amount" id="max_order_amount">
                            </div>
        ...
        function settings(){     
            ...
            if($("#settings").valid()) {
                ...
                $.ajax({
                    ...
                    url:"<?php echo e(url('admin/settings')); ?>",
                    method:'POST',
...
</html><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/theme/default.blade.php ENDPATH**/ ?>