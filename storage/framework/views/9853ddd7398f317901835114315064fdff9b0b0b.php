            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                        <?php echo $__env->make('theme.pincodetable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_pincode').on('submit', function(event){
        ...
        $.ajax({
            url:"<?php echo e(URL::to('admin/pincode/store')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editpincode').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"<?php echo e(URL::to('admin/pincode/update')); ?>",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
...
function GetData(id) {
    $.ajax({
        ...
        url:"<?php echo e(URL::to('admin/pincode/show')); ?>",
        data: {
            id: id
        },
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/pincode/destroy')); ?>",
                data: {
                    id: id
                },
                method: 'POST',
...
function PincodeTable() {
    $.ajax({
        url:"<?php echo e(URL::to('admin/pincode/list')); ?>",
        method:'get',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/pincode.blade.php ENDPATH**/ ?>