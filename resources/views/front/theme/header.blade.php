				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item {{ request()->is('product') ? 'active' : '' }}">
							<a class="nav-link" href="{{URL::to('/product')}}">Eat quality food</a>
						</li>
						...
						@if (Session::get('id'))
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									...
									<a class="dropdown-item" href="{{URL::to('/favorite')}}">My Favourites</a>
									<a class="dropdown-item" href="{{URL::to('/orders')}}">My Orders</a>
