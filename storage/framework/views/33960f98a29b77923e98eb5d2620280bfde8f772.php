...
<section class="signup-sec">
    ...
    <div class="container">
        ...
        <form id="login" action="<?php echo e(URL::to('/email-verification')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <input type="email" name="email" id="email" placeholder="Email Address" class="w-100" value="<?php echo e(Session::get('email')); ?>" readonly="">
            ...
            <p class="already">Didn't get Email ? <a href="<?php echo e(URL::to('/resend-email')); ?>">Resend</a></p>
...
</html><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/front/email-verify.blade.php ENDPATH**/ ?>