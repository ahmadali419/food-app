...
class AdminController extends Controller {
    ...
    public function home() {
        ...
        $subs_request = DB::table('subscription_request')->where('action', 0)->get();
        return view('home',compact('getcategory','getitems','addons','getusers','driver','contact','getreview','getorders','order_total','order_tax','getpromocode','todayorders','getdriver','subs_request'));
    }
