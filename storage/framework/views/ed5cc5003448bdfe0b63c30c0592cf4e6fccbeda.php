            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                        <?php echo $__env->make('theme.categorytable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_category').on('submit', function(event){
        ...
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(URL::to('admin/category/store')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editcategory').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"<?php echo e(URL::to('admin/category/update')); ?>",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
...
function GetData(id) {
    $.ajax({
        ...
        url:"<?php echo e(URL::to('admin/category/show')); ?>",
        data: {
            id: id
        },
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/category/status')); ?>",
                data: {
                    id: id,
                    status: status
                },
...
function CatetgoryTable() {
    $.ajax({
        url:"<?php echo e(URL::to('admin/category/list')); ?>",
        method:'get',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/category.blade.php ENDPATH**/ ?>