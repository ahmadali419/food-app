    ...
    <div class="row">
        <div class="col-lg-4 col-xl-3">
            <div class="card category-card">
                <div class="card-body">
                    <h4>Category</h4>
                    <p class="text-muted"><?php echo e($itemdetails->category_name); ?></p>

                    <h4>Price</h4>
                    <p><?php echo env('CURRENCY').''.number_format($itemdetails->item_price, 2); ?></p>

                    <h4>Delivery Time</h4>
                    <p><?php echo e($itemdetails->delivery_time); ?></p>
                    
                    <h4>Name</h4>
                    <p class="text-muted"><?php echo e($itemdetails->item_name); ?></p>

                    <h4>Description</h4>
                    <p class="text-muted"><?php echo e($itemdetails->item_description); ?></p>
                    ...
                    <div class="md-6">
                        ...
                        ?>
                        <div class="img-aside">
                            <img src='<?php echo asset("public/images/ingredients/".$ingredients->image); ?>' class="rounded img-thumbnail" style="width: 100px;">
                            <div class="img-aside-btn">
                                <button type="button" onClick="Editingredients('<?php echo e($ingredients->id); ?>')" class="btn mb-2 btn-sm btn-primary">Edit</button>
                                <button type="submit" onclick="Deleteingredients('<?php echo e($ingredients->id); ?>')" class="btn mb-2 btn-sm btn-danger">Delete</button>
                            </div>
                        </div>
                        <?php
                        }
        ...
        <div class="col-lg-8 col-xl-9">
            ...
            <div id="card-display">
                <?php echo $__env->make('theme.itemimage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
    <!-- End Row -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#addproduct').on('submit', function(event){
            ...
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/item/storeimages')); ?>",
                method:"POST",
                data:form_data,
                cache: false,
                contentType: false,
        ...
        $('#addingredients').on('submit', function(event){
            ...
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/item/storeingredientsimages')); ?>",
                method:"POST",
                data:form_data,
                cache: false,
                contentType: false,
        ...
        $('#editimg').on('submit', function(event){
            ...
            var form_data = new FormData(this);
            $.ajax({
                url:"<?php echo e(URL::to('admin/item/updateimage')); ?>",
                method:'POST',
                data:form_data,
                cache: false,
                contentType: false,
        ...
        $('#editingredients').on('submit', function(event){
            ...
            var form_data = new FormData(this);
            $.ajax({
                url:"<?php echo e(URL::to('admin/item/updateingredients')); ?>",
                method:'POST',
                data:form_data,
                cache: false,
                contentType: false,
    ...
    function EditDocument(id) {
        $.ajax({
            ...
            url:"<?php echo e(URL::to('admin/item/showimage')); ?>",
            data: {
                id: id
            },
    ...
    function Editingredients(id) {
        $.ajax({
            ...
            url:"<?php echo e(URL::to('admin/item/showingredients')); ?>",
            data: {
                id: id
            },
            method: 'POST', //Post method,
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    ...
                    url:"<?php echo e(URL::to('admin/item/destroyimage')); ?>",
                    data: {
                        id: id
                    },
                    method: 'POST',
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    ...
                    url:"<?php echo e(URL::to('admin/item/destroyingredients')); ?>",
                    data: {
                        id: id
                    },
                    method: 'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/item-images.blade.php ENDPATH**/ ?>