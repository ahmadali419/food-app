...
<section class="signup-sec">
    ...
    <div class="container">
        ...
        <form action="{{ URL::to('/signup/signup') }}" method="post">
            ...
            <input type="text" name="email" placeholder="Email Address" class="w-50" value="{{ old('email') }}">
            <input type="text" name="mobile" placeholder="Mobile Number" class="w-50" value="{{ old('mobile') }}">
            ...
            <label class="accept-check w-100" for="accept">
                ...
                <p class="already-p">I accept <a href="{{URL::to('/terms')}}"> terms & conditions </a></p>
            </label>

            <button class="btn">Create Account</button>
            <p class="already">I have <a href="{{URL::to('/signin')}}">already account</a></p>
        </form>
    </div>
</section>
