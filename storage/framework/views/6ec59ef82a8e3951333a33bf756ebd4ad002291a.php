...
$(document).ready(function() {
    ...
    $('#add_product').on('submit', function(event){
        ...
        $.ajax({
            url:"<?php echo e(URL::to('admin/item/store')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editproduct').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"<?php echo e(URL::to('admin/item/update')); ?>",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
...
function GetData(id) {
    $.ajax({
        ...
        url:"<?php echo e(URL::to('admin/item/show')); ?>",
        data: {
            id: id
        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/item.blade.php ENDPATH**/ ?>