            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                        <?php echo $__env->make('theme.addonstable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_addons').on('submit', function(event){
        ...
        $.ajax({
            url:"<?php echo e(URL::to('admin/addons/store')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editaddons').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"<?php echo e(URL::to('admin/addons/update')); ?>",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#cat_id').change(function()
    {
        ...
        $.ajax({
            ...
            type:'POST',
            url:"<?php echo e(URL::to('admin/addons/getitem')); ?>",
            data:{      
            'cat_id':cat_id
            },
            dataType: "json",
...
function GetData(id) {
    $.ajax({
        ...
        url:"<?php echo e(URL::to('admin/addons/show')); ?>",
        data: {
            id: id
        },
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"<?php echo e(URL::to('admin/addons/status')); ?>",
                data: {
                    id: id,
                    status: status
                },
...
function AddonsTable() {
    $.ajax({
        url:"<?php echo e(URL::to('admin/addons/list')); ?>",
        method:'get',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ab0ve3twa7yy/public_html/healthyandyummy.digitaltechs.co/resources/views/addons.blade.php ENDPATH**/ ?>