                        ...
                        <?php if(Session::get('id')): ?>
                            <?php if($getitem->item_status == '1'): ?>
                               ...
                               $count = \App\Cart::where(['user_id'=>Session::get('id'),'item_id'=>$getitem->id])->whereRaw('DATE(created_at)',$Date)->count(); ?>
                                ...
                                <?php if($count>=2): ?>
                                <!-- <button class="btn" style="display:none" onclick="AddtoCart('<?php echo e($getitem->id); ?>','<?php echo e(Session::get('id')); ?>')">Add to Cart</button> -->
                                 <?php else: ?>
...
</script><?php /**PATH D:\new-xampp\htdocs\app\resources\views/front/product-details.blade.php ENDPATH**/ ?>